...
% W_masque =
n = size(X_masque,1);
individu_moyen = sum(X_masque)/n;

% Centrage de la matrice X :
X_centre = X_masque-individu_moyen;
...
for k = 1:n-1
	img = reshape(vectPropresSigma(:,k), nb_lignes,nb_colonnes);
